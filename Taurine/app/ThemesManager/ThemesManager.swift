...
class ThemesManager {
    ...
    private let themes: [String: Theme] = [
        ...
        */
        "thorlight": Theme(
            ...
            backgroundImage: UIImage(named: "lightningGIF/6.jpg"),
            backgroundCenter: CGPoint(x: 1510, y: 800),
            backgroundOverlay: UIColor(white: 0, alpha: 0.3),
            enableBlur: false,
            copyrightString: "my gif to you"),
    ...
    public var currentTheme: Theme {
        let currentThemeName = UserDefaults.standard.string(forKey: "theme") ?? "league"
        return themes[currentThemeName] ?? themes["league"]!
    }
    ...
    init() {
        if UserDefaults.standard.string(forKey: "theme") == nil {
            UserDefaults.standard.set("thorlight", forKey: "theme")
        }
    }
}
